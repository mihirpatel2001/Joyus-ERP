    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8 max-w-md w-full">
        ...
        <div className="space-y-3">
          <h1 className="text-8xl font-bold text-primary-900 tracking-tighter">404</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
          ...
          <Button onClick={() => navigate('/')} className="w-full sm:w-auto shadow-lg shadow-primary-500/20">
