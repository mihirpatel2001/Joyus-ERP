...
import { NavItem, UserRole, RoleDefinition, Organization } from "./src/types/types";
...
export const DEFAULT_ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    name: "Admin",
    description:
      "Operational administrator with access to most business modules.",
    permissions: (() => {
...
export const MOCK_USERS = [
  {
    ...
    avatarUrl:
      "https://ui-avatars.com/api/?name=Super+Admin&background=0ea5e9&color=fff",
  ...
  },
  {
    ...
    role: UserRole.HR,
    avatarUrl:
      "https://ui-avatars.com/api/?name=HR+Manager&background=ec4899&color=fff",
  ...
  },
  {
    ...
    avatarUrl:
      "https://ui-avatars.com/api/?name=Michael+Ross&background=f59e0b&color=fff",
